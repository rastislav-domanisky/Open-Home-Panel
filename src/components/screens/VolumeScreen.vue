<template>
  <div class="volume_screen">
    ...
    <div class="content">
      ...
      max="100"
      >
      <button class="save-btn" v-on:click="setVolume">Save</button>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    setVolume() {
      axios
        .post("http://"+this.serverIp+":3000/volume", {
        ...
        .then(
          ...
          () => {
            console.log("volume: Cannot set volume");
          }
        );
    }
  },
  created() {
    axios
      .get("http://"+this.serverIp+":3000/get_volume", {
        headers: {
          "API-KEY": "openhomepanel123",
          "Content-Type": "application/json",
        },
